"""
SEE Detector — ML Pipeline v9 (Ultimate Features + GridSearchCV)
=================================================================
Strategi:
1. Drop `risk_score`.
2. Gunakan `see_categories` statis.
3. Ekstraksi fitur dinamis SANGAT mendalam, mendeteksi Reversed Base64, 
   trpc eksfiltrasi, dan pola PoC spesifik.
4. Gunakan GridSearchCV & 10-Fold CV.
=================================================================
"""
import os
import sys
...
OUTPUT_CSV    = os.path.join(RESULTS_DIR, "dataset_v9_ultimate.csv")
MODEL_PATH    = os.path.join(MODELS_DIR, "see_rf_model_v9.pkl")
FEATURES_PATH = os.path.join(MODELS_DIR, "feature_names_v9.pkl")
...
def build_dataset():
    ...
    suspicious_url_patterns = r'yapthread\.com|raw\.githubusercontent\.com|api\.telegram\.org|webhook|eval|data=|trpc'
...
def main():
    print("\n" + "=" * 66)
    print("  SEE DETECTOR - FULL ML PIPELINE v9 (ULTIMATE)")
    print("  (Kategori API Statis + Advanced Obfuscation Payload)")
    print("=" * 66)
